...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="">
                <h1 style="text-align: center;margin-top: 35px">Singapore Radar <small>(Rain View)</small>
                </h1>
            </div>
        </div>
    </div>
    <div class="row" style="min-height: 700px">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <ul class="map-control-list"
                style="text-align:center; position: absolute;top: 0; left: 0; right: 0; height: 50px;">
                <li><input type="button" class="btn btn-primary"
                        onclick="stop(); showFrame(animationPosition - 1); return;" value="&lt;" />
                </li>
                <li><input type="button" class="btn btn-primary" onclick="playStop();" value="Play / Stop" /></li>
                <li><input type="button" class="btn btn-primary"
                        onclick="stop(); showFrame(animationPosition + 1); return;" value="&gt;" />
                </li>
            </ul>
            ...
            <div id="mapid"
                style="position: absolute; top: 80px; left: 0; bottom: 0; right: 0;min-height: 650px;width: 100%;height: 100%">
            </div>

        </div>
    </div>
    <script>
        var map = L.map('mapid').setView([1.370270, 103.818959], 12);
